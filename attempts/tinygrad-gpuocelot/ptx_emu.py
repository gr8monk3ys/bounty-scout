...
class Executor:
    ...
    def write(self, t: Thread, tok: str, val: Any, ty: str | None) -> None:
        t.regs[tok.strip().lstrip("%")] = _truncate(val, ty)
